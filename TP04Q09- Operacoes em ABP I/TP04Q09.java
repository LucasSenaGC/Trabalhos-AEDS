...
class ArvoreBinaria {
	...
	/**
	 * Metodo que retorna o maior elemento da arvore
	 * @return int maior elemento da arvore
	 */
   public char getMaior(){
	...
	/**
	 * Metodo que retorna o menor elemento da arvore
	 * @return int menor elemento da arvore
	 */
...
class TP04Q09 {
    public static char getComando(String str){
        char resp = '.';
    ...
    public static char getPosEspaco(String str){
        char resp = '.';
        int count = 0;
        for(int i = 0; i < str.length(); i++){
            if(str.charAt(i) == ' '){
    ...
    public static void main(String[] args) throws Exception{
        ...
        while(console.hasNext()){
            ...
            && entrada.compareTo("PREFIXA") != 0 
            &&entrada.compareTo("POSFIXA") != 0 ){
                caracter = getComando(entrada);
                //MyIO.println(entrada);
                //MyIO.println("caracter = " + caracter);
                if(caracter == 'P'){
                    temp = getPosEspaco(entrada);
                    pesquisa = arvore.pesquisar(temp);
                    if(pesquisa == true){
                        MyIO.println(temp + " existe");
                    }else{
                        MyIO.println(temp + " nao existe");
                    }
                    //MyIO.println("TEMP = " + temp);
                }else if(caracter == 'I'){
                    temp = getPosEspaco(entrada);
                    arvore.inserir(temp);
                }
                //arvore.inserir(caracter);
                

            }else if(entrada.compareTo("INFIXA") == 0){
