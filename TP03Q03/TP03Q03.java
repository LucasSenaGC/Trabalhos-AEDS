...
class Lista {
    ...
    */
    ...
    /**
    * Algoritmo de ordenacao por insercao para o atributo data lancamento.
    */
    public void InsercaoSort() {
        for (int i = 1; i < n; i++) {
            ...
            comparacoes++;
            while ((j >= 0) && (filmes[j].getDatalancamento().after(tmp.getDatalancamento()) == true)) {
                filmes[j + 1] = filmes[j];
                j--;
                movimentacoes++;
            }
            /*if(j>=0){
                MyIO.println(filmes[j].sdf.format(filmes[j].getDatalancamento()) + " = " + tmp.sdf.format(tmp.getDatalancamento())+ " SITUACAO: " +filmes[j].getDatalancamento().compareTo(tmp.getDatalancamento()));
            }*/
            
            if((j >= 0) && (filmes[j].getDatalancamento().equals(tmp.getDatalancamento()) == true)){
                //MyIO.println(filmes[j].getNome() + " = " + tmp.getNome());
                InsercaoSortequals();
            }
    ...
    public void InsercaoSortequals(){
        for (int i = 1; i < n; i++) {
            Filme tmp = filmes[i];
            int j = i - 1;

            
            while ((j >= 0) && (filmes[j].getDatalancamento().equals(tmp.getDatalancamento()) == true) && 
            (filmes[j].getNome().charAt(0) > tmp.getNome().charAt(0))) {
                filmes[j + 1] = filmes[j];
                j--;
                comparacoes+=2;
                movimentacoes++;
            ...
            while ((j >= 0) && (filmes[j].getDatalancamento().equals(tmp.getDatalancamento()) == true) && 
            (filmes[j].getNome().charAt(0) == tmp.getNome().charAt(0)) &&
            (filmes[j].getNome().charAt(1) > tmp.getNome().charAt(1))) {
                filmes[j + 1] = filmes[j];
                j--;
                comparacoes+=3;
                movimentacoes++;
            ...
            (filmes[j].getNome().charAt(0) == tmp.getNome().charAt(0)) &&
            (filmes[j].getNome().charAt(1) == tmp.getNome().charAt(1)) && 
            (filmes[j].getNome().charAt(2) > tmp.getNome().charAt(2))) {
                filmes[j + 1] = filmes[j];
                j--;
                comparacoes+=4;
                movimentacoes++;
            ...
            (filmes[j].getNome().charAt(1) == tmp.getNome().charAt(1)) && 
            (filmes[j].getNome().charAt(2) == tmp.getNome().charAt(2)) && 
            (filmes[j].getNome().charAt(3) > tmp.getNome().charAt(3))) {
                filmes[j + 1] = filmes[j];
                j--;
                comparacoes+=5;
                movimentacoes++;
            ...
            (filmes[j].getNome().charAt(2) == tmp.getNome().charAt(2)) &&
            (filmes[j].getNome().charAt(3) == tmp.getNome().charAt(3)) && 
            (filmes[j].getNome().charAt(4) > tmp.getNome().charAt(4))) {
                filmes[j + 1] = filmes[j];
                j--;
                comparacoes+=6;
                movimentacoes++;
            ...
            (filmes[j].getNome().charAt(3) == tmp.getNome().charAt(3)) &&
            (filmes[j].getNome().charAt(4) == tmp.getNome().charAt(4)) && 
            (filmes[j].getNome().charAt(5) > tmp.getNome().charAt(5))) {
                filmes[j + 1] = filmes[j];
                j--;
                comparacoes+=7;
                movimentacoes++;
