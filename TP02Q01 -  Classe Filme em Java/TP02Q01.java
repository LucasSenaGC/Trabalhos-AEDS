...
class Filme{
    ...
    public void ler(String entrada) throws Exception{
        ...
        //MyIO.println(sdf.format(getDatalancamento()));
        ...
        //MyIO.println(getTituloOriginal());
        ...
        setSituacao(linha);
        //MyIO.println("SITUACAO = " + getSituacao());
        ...
        //MyIO.println("IDIOMA ORIGINAL = " + getIdiomaOriginal());
        ...
        setOrcamento(valor);
        //MyIO.println("ORCAMENTOOOOOOOOOO = " + getOrcamento() );
...
class TP02Q01{
    ...
    public static void main(String[] args) throws Exception{
        ...
        //Criar um array de filmes e fazer a leitura de cada html, fazendo sets em seus atributos e depois chamar o metodo imprimir;
