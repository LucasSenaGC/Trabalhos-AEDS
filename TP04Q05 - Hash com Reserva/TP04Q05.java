...
class Hash {
    ...
    public boolean inserir(Filme elemento) {
       ...
       //MyIO.println("SOMA INSERIR = " + soma);
       if (elemento != NULO) {
          int pos = h(soma);
          //MyIO.println("FILME INSERIR = " + elemento.getTituloOriginal());
          if (tabela[pos] == NULO) {
             tabela[pos] = elemento;
             resp = true;
          } else if (reserva < m2) {
    ...
    public boolean pesquisar(String elemento) {
       ...
       //MyIO.println("SOMA PESQUISAR = " + soma);
       int pos = h(soma);
       //MyIO.println("h Pesquisar = " + pos);
