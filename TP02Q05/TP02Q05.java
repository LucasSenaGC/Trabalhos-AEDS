      ...
      for (int i = 0; i < (n - 1); i++) {
         ...
         for (int j = (i + 1); j < n; j++){
            if ((int)filmes[menor].getNome().charAt(0) > (int)filmes[j].getNome().charAt(0)){
               menor = j;
            }else if((int)filmes[menor].getNome().charAt(0) > (int)filmes[j].getNome().charAt(0)){
...
class TP02Q05{
    ...
    public static void main(String[] args) throws Exception{
        ...
        for(int i = 0; i < n; i++){
            ...
            if(segundaEntrada.contains("II")){
                
                segundaEntrada = removerTresChars(segundaEntrada);
                
                filmes[++count] = new Filme();
                filmes[count].ler(segundaEntrada);
                replica = filmes[count].clone();
                 
                lista.inserirInicio(replica);

            }else if(segundaEntrada.contains("I*")){

                segundaEntrada = removerTresChars(segundaEntrada);
                pos = Integer.parseInt(lerAteEspaco(segundaEntrada));
                segundaEntrada = apenasEnderecoFilme(segundaEntrada);
                ...
                lista.inserir(replica, pos);

            }else if(segundaEntrada.contains("IF")){
                ...
                lista.inserirFim(replica);
            }else if(segundaEntrada.contains("RI")){

                removido = lista.removerInicio();
                MyIO.println("(R) " + removido.getNome());

            }else if(segundaEntrada.contains("R*")){

                pos = Integer.parseInt(lerAteEspaco(removerTresChars(segundaEntrada)));

                removido = lista.remover(pos);
                MyIO.println("(R) " + removido.getNome());
                
            }else if(segundaEntrada.contains("RF")){

                removido = lista.removerFim();
                MyIO.println("(R) " + removido.getNome());

            }else{
                MyIO.println("ERRO!! WRONG INPUT !!!");
            }
